...
export function cssBlockTemplate(selector, styles) {
  const cssLines = [];
    ...
    if (styles.flexDirection) cssLines.push(`  flex-direction: ${styles.flexDirection};`);
    if (styles.justifyContent) cssLines.push(`  justify-content: ${styles.justifyContent};`);
    ...
    if (styles.backgroundColor) cssLines.push(`  background-color: ${styles.backgroundColor};`);
    if (styles.border) cssLines.push(`  border: ${styles.border};`);
    if (styles.borderRadius) cssLines.push(`  border-radius: ${styles.borderRadius};`);
    ...
    if (styles.textDecoration) cssLines.push(`  text-decoration: ${styles.textDecoration};`);
